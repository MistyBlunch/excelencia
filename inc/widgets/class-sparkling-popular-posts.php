...
class Sparkling_Popular_Posts extends WP_Widget {
	...
	public function enqueue() {
		...
		if ( is_admin() ) {
			wp_enqueue_script( 'sparkling-popular-post-script', get_template_directory_uri() . '/js/widget.js', array( 'jquery' ) );
			$args = array(
						  ...
						  <div class="post-image <?php echo get_post_format(); ?>">
                            ...
                            <div class="media">
                                ...
                                if ( has_post_thumbnail() ) {
                                    ...
                                    $htmlImage = '<img width="64px" src="'.$image[0].'" class="align-self-start mr-3" />';
